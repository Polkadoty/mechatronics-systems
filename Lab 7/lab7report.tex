...
\begin{figure}[H]
    \centering
    \frame{\includegraphics[width = 0.75\textwidth]{lab7/lab7images/wingmodellab7.png}}
...
\begin{figure}[H]
    \centering
    \frame{\includegraphics[width = 0.5\textwidth]{lab7/lab7images/loadcellcalib.png}}
...
\begin{figure}[H]
    \centering
    \frame{\includegraphics[width=0.75\textwidth]{lab7/lab7images/lab7circuitloadcell.jpg}}
...
\begin{figure}[H]
    \centering
    \frame{\includegraphics[width=0.75\textwidth]{lab7/lab7images/lab7blockdiagram1.PNG}}
...
% tip displacement vs Freq %
% Force vs Freq %
% Accel vs Freq %
% ^^^ THESE 3 NEXT TO EACHOTHER %

% Frequency Response %%%%% in its own spot %%%%%
