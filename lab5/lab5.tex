...
\begin{figure}[H]
    \centering
    \frame{\includegraphics[width = 0.5\textwidth]{Half_bridge_configs.png}}
    \caption{Half-Bridge Configurations, $V_{OUT}$ between $S^{+}$ and $S^{-}$}
\end{figure}
\begin{figure}[H]
    \centering
    \frame{\includegraphics[width = 0.75\textwidth]{configB_circuit.png}}
...
\begin{center}
    \frame{\includegraphics[width= 0.52\textwidth]{blockdiag_labview_5.png}}
\end{center}
